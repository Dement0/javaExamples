...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BlackHoleBox bh_box = new BlackHoleBox();
        bh_box.add(new Thing("Saludo", 5));
        bh_box.add(new Thing("Pirkka", 5));

        System.out.println(bh_box.isInTheBox(new Thing("Saludo")));
        System.out.println(bh_box.isInTheBox(new Thing("Pirkka")));
    }
}
